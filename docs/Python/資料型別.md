...
``````
![字串](../../static/img/docker/docker_py_字串.png "字串")
...
```````
![字串2](../../static/img/docker/docker_py_字串2.png "字串2")
![字串3](../../static/img/docker/docker_py_字串3.png "字串3")
...
````````
![字串轉換整數](../../static/img/docker/docker_py_字串轉換整數.png "字串轉換整數")
`````````
百分比格式化
stuff = 'pen'
price = 5
