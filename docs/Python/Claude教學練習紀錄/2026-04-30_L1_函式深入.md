...
```python
stats(3, 1, 7, 2)
# nums = (3, 1, 7, 2)   ← 自動包成 tuple
# max((3,1,7,2)) = 7, min(...) = 1, sum(...)/4 = 3.25

stats(10, 20)
# nums = (10, 20)
# max = 20, min = 10, avg = 15.0
```
...
stats(3, 1, 7)   # TypeError: stats() takes 1 argument but 3 were given
                 # stats 只定義了 1 個參數，卻傳了 3 個進去
